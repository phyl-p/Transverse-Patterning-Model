...
%positive outcome
connectionTable(3*stim_nrns+3*dec_nrns:3*stim_nrns+3*dec_nrns+1+outcome_nrns,1)=5;
%negative outcome
connectionTable(3*stim_nrns+3*dec_nrns+1+outcome_nrns+1:3*stim_nrns+3*dec_nrns+1+2*outcome_nrns+1,1)=6;
